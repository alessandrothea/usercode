...
// Mon Feb 21 16:55:40 2011 by ROOT version 5.22/00d
...
public :
   ...
   Double_t        EcalGapBE[25];   //[NECALGapClusters]
   Int_t           EcalGapClusterSize[25];   //[NECALGapClusters]
   Int_t           NGenLeptons;
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      ...
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("dcap://t3se01.psi.ch:22125/pnfs/psi.ch/cms/trivcat/store/user/susy/ntuples/mc/V01-11-03/TTTo2L2Nu2B_7TeV-powheg-pythia6/NTupleProducer_38X_MC_RECO_23_4_R9X.root");
      if (!f) {
         f = new TFile("dcap://t3se01.psi.ch:22125/pnfs/psi.ch/cms/trivcat/store/user/susy/ntuples/mc/V01-11-03/TTTo2L2Nu2B_7TeV-powheg-pythia6/NTupleProducer_38X_MC_RECO_23_4_R9X.root");
         f->cd("PyROOT:/");
      }
      ...
      chain->Add("dcap://t3se01.psi.ch:22125/pnfs/psi.ch/cms/trivcat/store/user/susy/ntuples/mc/V01-11-03/TTTo2L2Nu2B_7TeV-powheg-pythia6/NTupleProducer_38X_MC_RECO_23_4_R9X.root/analyze/Analysis");
      tree = chain;
#endif // SINGLE_TREE
