...
// Fri Dec 10 00:38:39 2010 by ROOT version 5.22/00d
// from TChain analyze/Analysis/
//////////////////////////////////////////////////////////

#ifndef ETHZNtupleReader_h
#define ETHZNtupleReader_h

#include <TROOT.h>
#include <TChain.h>
#include <TFile.h>

class ETHZNtupleReader {
public :
   ...
   Double_t        EcalGapBE[9];   //[NECALGapClusters]
   Int_t           EcalGapClusterSize[9];   //[NECALGapClusters]
   Int_t           NGenLeptons;
   Int_t           GenLeptonID[7];   //[NGenLeptons]
   Double_t        GenLeptonPt[7];   //[NGenLeptons]
   Double_t        GenLeptonEta[7];   //[NGenLeptons]
   Double_t        GenLeptonPhi[7];   //[NGenLeptons]
   Int_t           GenLeptonMID[7];   //[NGenLeptons]
   Int_t           GenLeptonMStatus[7];   //[NGenLeptons]
   Double_t        GenLeptonMPt[7];   //[NGenLeptons]
   Double_t        GenLeptonMEta[7];   //[NGenLeptons]
   Double_t        GenLeptonMPhi[7];   //[NGenLeptons]
   Int_t           GenLeptonGMID[7];   //[NGenLeptons]
   Int_t           GenLeptonGMStatus[7];   //[NGenLeptons]
   Double_t        GenLeptonGMPt[7];   //[NGenLeptons]
   Double_t        GenLeptonGMEta[7];   //[NGenLeptons]
   Double_t        GenLeptonGMPhi[7];   //[NGenLeptons]
   Int_t           NVrtx;
   Double_t        VrtxX[3];   //[NVrtx]
   Double_t        VrtxY[3];   //[NVrtx]
   Double_t        VrtxZ[3];   //[NVrtx]
   Double_t        VrtxXE[3];   //[NVrtx]
   Double_t        VrtxYE[3];   //[NVrtx]
   Double_t        VrtxZE[3];   //[NVrtx]
   Double_t        VrtxNdof[3];   //[NVrtx]
   Double_t        VrtxChi2[3];   //[NVrtx]
   Double_t        VrtxNtrks[3];   //[NVrtx]
   Double_t        VrtxSumPt[3];   //[NVrtx]
   Int_t           VrtxIsFake[3];   //[NVrtx]
   Int_t           NMus;
   Int_t           NMusTot;
   Int_t           NGMus;
   Int_t           NTMus;
   ...
   Int_t           MuIsGlobalMuon[5];   //[NMus]
   Int_t           MuIsTrackerMuon[5];   //[NMus]
   ...
   Double_t        MuIso03EMVetoEt[5];   //[NMus]
   Double_t        MuIso03HadVetoEt[5];   //[NMus]
   ...
   Int_t           MuNPxHits[5];   //[NMus]
   Double_t        MuInnerTkNChi2[5];   //[NMus]
   Int_t           MuNMatches[5];   //[NMus]
   Int_t           MuNChambers[5];   //[NMus]
   Double_t        MuCaloComp[5];   //[NMus]
   Double_t        MuSegmComp[5];   //[NMus]
   Int_t           MuIsGMPT[5];   //[NMus]
   Int_t           MuIsGMTkChiComp[5];   //[NMus]
   Int_t           MuIsGMStaChiComp[5];   //[NMus]
   Int_t           MuIsGMTkKinkTight[5];   //[NMus]
   Int_t           MuIsAllStaMuons[5];   //[NMus]
   Int_t           MuIsAllTrkMuons[5];   //[NMus]
   Int_t           MuIsTrkMuonArbitrated[5];   //[NMus]
   Int_t           MuIsAllArbitrated[5];   //[NMus]
   Int_t           MuIsTMLSLoose[5];   //[NMus]
   Int_t           MuIsTMLSTight[5];   //[NMus]
   Int_t           MuIsTM2DCompLoose[5];   //[NMus]
   Int_t           MuIsTM2DCompTight[5];   //[NMus]
   Int_t           MuIsTMOneStationLoose[5];   //[NMus]
   Int_t           MuIsTMOneStationTight[5];   //[NMus]
   Int_t           MuIsTMLSOptLowPtLoose[5];   //[NMus]
   Int_t           MuIsTMLSAngLoose[5];   //[NMus]
   Int_t           MuIsTMLastStationAngTight[5];   //[NMus]
   Int_t           MuIsTMOneStationAngTight[5];   //[NMus]
   Int_t           MuIsTMOneStationAngLoose[5];   //[NMus]
   Double_t        MuOutPosRadius[5];   //[NMus]
   Double_t        MuOutPosX[5];   //[NMus]
   Double_t        MuOutPosY[5];   //[NMus]
   Double_t        MuOutPosZ[5];   //[NMus]
   Double_t        MuOutMomx[5];   //[NMus]
   Double_t        MuOutMomy[5];   //[NMus]
   Double_t        MuOutMomz[5];   //[NMus]
   Double_t        MuOutMomPhi[5];   //[NMus]
   Double_t        MuOutMomEta[5];   //[NMus]
   Double_t        MuOutMomTheta[5];   //[NMus]
   Int_t           MuGenID[5];   //[NMus]
   Int_t           MuGenStatus[5];   //[NMus]
   Int_t           MuGenCharge[5];   //[NMus]
   Double_t        MuGenPt[5];   //[NMus]
   Double_t        MuGenEta[5];   //[NMus]
   Double_t        MuGenPhi[5];   //[NMus]
   Double_t        MuGenE[5];   //[NMus]
   Int_t           MuGenMID[5];   //[NMus]
   Int_t           MuGenMStatus[5];   //[NMus]
   Int_t           MuGenMCharge[5];   //[NMus]
   Double_t        MuGenMPt[5];   //[NMus]
   Double_t        MuGenMEta[5];   //[NMus]
   Double_t        MuGenMPhi[5];   //[NMus]
   Double_t        MuGenME[5];   //[NMus]
   Int_t           MuGenGMID[5];   //[NMus]
   Int_t           MuGenGMStatus[5];   //[NMus]
   Int_t           MuGenGMCharge[5];   //[NMus]
   Double_t        MuGenGMPt[5];   //[NMus]
   Double_t        MuGenGMEta[5];   //[NMus]
   Double_t        MuGenGMPhi[5];   //[NMus]
   Double_t        MuGenGME[5];   //[NMus]
   Int_t           NEles;
   Int_t           NElesTot;
   Int_t           ElGood[3];   //[NEles]
   Int_t           ElIsIso[3];   //[NEles]
   Int_t           ElChargeMisIDProb[3];   //[NEles]
   Double_t        ElPx[3];   //[NEles]
   Double_t        ElPy[3];   //[NEles]
   Double_t        ElPz[3];   //[NEles]
   Double_t        ElPt[3];   //[NEles]
   Double_t        ElPtE[3];   //[NEles]
   Double_t        ElE[3];   //[NEles]
   Double_t        ElEt[3];   //[NEles]
   Double_t        ElEta[3];   //[NEles]
   Double_t        ElTheta[3];   //[NEles]
   Double_t        ElSCEta[3];   //[NEles]
   Double_t        ElPhi[3];   //[NEles]
   Double_t        ElD0BS[3];   //[NEles]
   Double_t        ElD0PV[3];   //[NEles]
   Double_t        ElD0E[3];   //[NEles]
   Double_t        ElDzBS[3];   //[NEles]
   Double_t        ElDzPV[3];   //[NEles]
   Double_t        ElDzE[3];   //[NEles]
   Double_t        ElRelIso03[3];   //[NEles]
   Double_t        ElRelIso04[3];   //[NEles]
   Double_t        ElDR03TkSumPt[3];   //[NEles]
   Double_t        ElDR04TkSumPt[3];   //[NEles]
   Double_t        ElDR03EcalRecHitSumEt[3];   //[NEles]
   Double_t        ElDR04EcalRecHitSumEt[3];   //[NEles]
   Double_t        ElDR03HcalTowerSumEt[3];   //[NEles]
   Double_t        ElDR04HcalTowerSumEt[3];   //[NEles]
   Double_t        ElNChi2[3];   //[NEles]
   Int_t           ElCharge[3];   //[NEles]
   Int_t           ElCInfoIsGsfCtfCons[3];   //[NEles]
   Int_t           ElCInfoIsGsfCtfScPixCons[3];   //[NEles]
   Int_t           ElCInfoIsGsfScPixCons[3];   //[NEles]
   Int_t           ElScPixCharge[3];   //[NEles]
   Double_t        ElClosestCtfTrackPt[3];   //[NEles]
   Double_t        ElClosestCtfTrackEta[3];   //[NEles]
   Double_t        ElClosestCtfTrackPhi[3];   //[NEles]
   Int_t           ElClosestCtfTrackCharge[3];   //[NEles]
   Double_t        ElIDMva[3];   //[NEles]
   Int_t           ElIDTight[3];   //[NEles]
   Int_t           ElIDLoose[3];   //[NEles]
   Int_t           ElIDRobustTight[3];   //[NEles]
   Int_t           ElIDRobustLoose[3];   //[NEles]
   Int_t           ElIDsimpleWPrelIso[3];   //[NEles]
   Int_t           ElIDsimpleWP80relIso[3];   //[NEles]
   Int_t           ElIDsimpleWP95relIso[3];   //[NEles]
   Int_t           ElInGap[3];   //[NEles]
   Int_t           ElEcalDriven[3];   //[NEles]
   Int_t           ElTrackerDriven[3];   //[NEles]
   Int_t           ElBasicClustersSize[3];   //[NEles]
   Double_t        Elfbrem[3];   //[NEles]
   Double_t        ElHcalOverEcal[3];   //[NEles]
   Double_t        ElE1x5[3];   //[NEles]
   Double_t        ElE5x5[3];   //[NEles]
   Double_t        ElE2x5Max[3];   //[NEles]
   Double_t        ElSigmaIetaIeta[3];   //[NEles]
   Double_t        ElDeltaPhiSeedClusterAtCalo[3];   //[NEles]
   Double_t        ElDeltaEtaSeedClusterAtCalo[3];   //[NEles]
   Double_t        ElDeltaPhiSuperClusterAtVtx[3];   //[NEles]
   Double_t        ElDeltaEtaSuperClusterAtVtx[3];   //[NEles]
   Double_t        ElCaloEnergy[3];   //[NEles]
   Double_t        ElTrkMomAtVtx[3];   //[NEles]
   Double_t        ElESuperClusterOverP[3];   //[NEles]
   Int_t           ElNumberOfMissingInnerHits[3];   //[NEles]
   Int_t           ElIsInJet[3];   //[NEles]
   Double_t        ElSharedPx[3];   //[NEles]
   Double_t        ElSharedPy[3];   //[NEles]
   Double_t        ElSharedPz[3];   //[NEles]
   Double_t        ElSharedEnergy[3];   //[NEles]
   Int_t           ElDuplicateEl[3];   //[NEles]
   Double_t        ElConvPartnerTrkDist[3];   //[NEles]
   Double_t        ElConvPartnerTrkDCot[3];   //[NEles]
   Double_t        ElConvPartnerTrkPt[3];   //[NEles]
   Double_t        ElConvPartnerTrkEta[3];   //[NEles]
   Double_t        ElConvPartnerTrkPhi[3];   //[NEles]
   Double_t        ElConvPartnerTrkCharge[3];   //[NEles]
   Int_t           ElScSeedSeverity[3];   //[NEles]
   Double_t        ElE1OverE9[3];   //[NEles]
   Double_t        ElS4OverS1[3];   //[NEles]
   Int_t           ElGenID[3];   //[NEles]
   Int_t           ElGenStatus[3];   //[NEles]
   Int_t           ElGenCharge[3];   //[NEles]
   Double_t        ElGenPt[3];   //[NEles]
   Double_t        ElGenEta[3];   //[NEles]
   Double_t        ElGenPhi[3];   //[NEles]
   Double_t        ElGenE[3];   //[NEles]
   Int_t           ElGenMID[3];   //[NEles]
   Int_t           ElGenMStatus[3];   //[NEles]
   Int_t           ElGenMCharge[3];   //[NEles]
   Double_t        ElGenMPt[3];   //[NEles]
   Double_t        ElGenMEta[3];   //[NEles]
   Double_t        ElGenMPhi[3];   //[NEles]
   Double_t        ElGenME[3];   //[NEles]
   Int_t           ElGenGMID[3];   //[NEles]
   Int_t           ElGenGMStatus[3];   //[NEles]
   Int_t           ElGenGMCharge[3];   //[NEles]
   Double_t        ElGenGMPt[3];   //[NEles]
   Double_t        ElGenGMEta[3];   //[NEles]
   Double_t        ElGenGMPhi[3];   //[NEles]
   Double_t        ElGenGME[3];   //[NEles]
   Int_t           NPhotons;
   Int_t           NPhotonsTot;
   Int_t           PhoGood[6];   //[NPhotons]
   Int_t           PhoIsIso[6];   //[NPhotons]
   Double_t        PhoPt[6];   //[NPhotons]
   Double_t        PhoPx[6];   //[NPhotons]
   Double_t        PhoPy[6];   //[NPhotons]
   Double_t        PhoPz[6];   //[NPhotons]
   Double_t        PhoEta[6];   //[NPhotons]
   Double_t        PhoPhi[6];   //[NPhotons]
   Double_t        PhoEnergy[6];   //[NPhotons]
   Double_t        PhoIso03Ecal[6];   //[NPhotons]
   Double_t        PhoIso03Hcal[6];   //[NPhotons]
   Double_t        PhoIso03TrkSolid[6];   //[NPhotons]
   Double_t        PhoIso03TrkHollow[6];   //[NPhotons]
   Double_t        PhoIso03[6];   //[NPhotons]
   Double_t        PhoIso04Ecal[6];   //[NPhotons]
   Double_t        PhoIso04Hcal[6];   //[NPhotons]
   Double_t        PhoIso04TrkSolid[6];   //[NPhotons]
   Double_t        PhoIso04TrkHollow[6];   //[NPhotons]
   Double_t        PhoIso04[6];   //[NPhotons]
   Double_t        PhoCaloPositionX[6];   //[NPhotons]
   Double_t        PhoCaloPositionY[6];   //[NPhotons]
   Double_t        PhoCaloPositionZ[6];   //[NPhotons]
   Double_t        PhoHoverE[6];   //[NPhotons]
   Double_t        PhoH1overE[6];   //[NPhotons]
   Double_t        PhoH2overE[6];   //[NPhotons]
   Double_t        PhoSigmaIetaIeta[6];   //[NPhotons]
   Int_t           PhoHasPixSeed[6];   //[NPhotons]
   Int_t           PhoHasConvTrks[6];   //[NPhotons]
   Int_t           PhoIsInJet[6];   //[NPhotons]
   Int_t           PhoIsElDupl[6];   //[NPhotons]
   Double_t        PhoSharedPx[6];   //[NPhotons]
   Double_t        PhoSharedPy[6];   //[NPhotons]
   Double_t        PhoSharedPz[6];   //[NPhotons]
   Double_t        PhoSharedEnergy[6];   //[NPhotons]
   Int_t           PhoScSeedSeverity[6];   //[NPhotons]
   Double_t        PhoE1OverE9[6];   //[NPhotons]
   Double_t        PhoS4OverS1[6];   //[NPhotons]
   Int_t           NJets;
   Int_t           NJetsTot;
   Int_t           JGood[6];   //[NJets]
   Double_t        JPx[6];   //[NJets]
   Double_t        JPy[6];   //[NJets]
   Double_t        JPz[6];   //[NJets]
   Double_t        JPt[6];   //[NJets]
   Double_t        JE[6];   //[NJets]
   Double_t        JEt[6];   //[NJets]
   Double_t        JEta[6];   //[NJets]
   Double_t        JPhi[6];   //[NJets]
   Double_t        JEMfrac[6];   //[NJets]
   Int_t           JNConstituents[6];   //[NJets]
   Double_t        JID_HPD[6];   //[NJets]
   Double_t        JID_RBX[6];   //[NJets]
   Double_t        JID_n90Hits[6];   //[NJets]
   Double_t        JID_resEMF[6];   //[NJets]
   Double_t        JID_HCALTow[6];   //[NJets]
   Double_t        JID_ECALTow[6];   //[NJets]
   Double_t        JEtaRms[6];   //[NJets]
   Double_t        JPhiRms[6];   //[NJets]
   Double_t        JbTagProbTkCntHighEff[6];   //[NJets]
   Double_t        JbTagProbTkCntHighPur[6];   //[NJets]
   Double_t        JbTagProbSimpSVHighEff[6];   //[NJets]
   Double_t        JbTagProbSimpSVHighPur[6];   //[NJets]
   Double_t        JChfrac[6];   //[NJets]
   Double_t        JEFracHadronic[6];   //[NJets]
   Double_t        JMass[6];   //[NJets]
   Int_t           JNAssoTracks[6];   //[NJets]
   Double_t        Jtrk1px[6];   //[NJets]
   Double_t        Jtrk1py[6];   //[NJets]
   Double_t        Jtrk1pz[6];   //[NJets]
   Double_t        Jtrk2px[6];   //[NJets]
   Double_t        Jtrk2py[6];   //[NJets]
   Double_t        Jtrk2pz[6];   //[NJets]
   Double_t        Jtrk3px[6];   //[NJets]
   Double_t        Jtrk3py[6];   //[NJets]
   Double_t        Jtrk3pz[6];   //[NJets]
   Double_t        JEcorr[6];   //[NJets]
   Double_t        JeMinDR[6];   //[NJets]
   Double_t        JVtxx[6];   //[NJets]
   Double_t        JVtxy[6];   //[NJets]
   Double_t        JVtxz[6];   //[NJets]
   Double_t        JVtxExx[6];   //[NJets]
   Double_t        JVtxEyx[6];   //[NJets]
   Double_t        JVtxEyy[6];   //[NJets]
   Double_t        JVtxEzy[6];   //[NJets]
   Double_t        JVtxEzz[6];   //[NJets]
   Double_t        JVtxEzx[6];   //[NJets]
   Double_t        JVtxNChi2[6];   //[NJets]
   Double_t        JGenPt[6];   //[NJets]
   Double_t        JGenEta[6];   //[NJets]
   Double_t        JGenPhi[6];   //[NJets]
   Double_t        JGenE[6];   //[NJets]
   Double_t        JGenEmE[6];   //[NJets]
   Double_t        JGenHadE[6];   //[NJets]
   Double_t        JGenInvE[6];   //[NJets]
   Int_t           PFNJets;
   ...
   Double_t        PFJbTagProbTkCntHighEff[9];   //[PFNJets]
   Double_t        PFJbTagProbTkCntHighPur[9];   //[PFNJets]
   Double_t        PFJbTagProbSimpSVHighEff[9];   //[PFNJets]
   Double_t        PFJbTagProbSimpSVHighPur[9];   //[PFNJets]
   Int_t           PFJChMult[9];   //[PFNJets]
   Int_t           PFJNeuMult[9];   //[PFNJets]
   ...
   Int_t           CANJets;
   Double_t        CAJPx[6];   //[CANJets]
   Double_t        CAJPy[6];   //[CANJets]
   Double_t        CAJPz[6];   //[CANJets]
   Double_t        CAJPt[6];   //[CANJets]
   Double_t        CAJE[6];   //[CANJets]
   Double_t        CAJEt[6];   //[CANJets]
   Double_t        CAJEta[6];   //[CANJets]
   Double_t        CAJPhi[6];   //[CANJets]
   Double_t        CAJScale[6];   //[CANJets]
   Double_t        CAJbTagProbTkCntHighEff[6];   //[CANJets]
   Double_t        CAJbTagProbTkCntHighPur[6];   //[CANJets]
   Double_t        CAJbTagProbSimpSVHighEff[6];   //[CANJets]
   Double_t        CAJbTagProbSimpSVHighPur[6];   //[CANJets]
   Double_t        CAJID_HPD[6];   //[CANJets]
   Double_t        CAJID_RBX[6];   //[CANJets]
   Double_t        CAJID_n90Hits[6];   //[CANJets]
   Double_t        CAJID_resEMF[6];   //[CANJets]
   Double_t        CAJEMfrac[6];   //[CANJets]
   Int_t           CAJNAssoTracks[6];   //[CANJets]
   Double_t        CAJChfrac[6];   //[CANJets]
   Int_t           CAJNConstituents[6];   //[CANJets]
   Int_t           NTracks;
   Int_t           NTracksTot;
   Int_t           TrkGood[60];   //[NTracks]
   Double_t        TrkPt[60];   //[NTracks]
   Double_t        TrkEta[60];   //[NTracks]
   Double_t        TrkPhi[60];   //[NTracks]
   Double_t        TrkNChi2[60];   //[NTracks]
   Double_t        TrkNHits[60];   //[NTracks]
   Double_t        TrkPtSumx;
   Double_t        TrkPtSumy;
   Double_t        TrkPtSum;
   ...
   ETHZNtupleReader(TTree *tree=0);
   virtual ~ETHZNtupleReader();
...
#ifdef ETHZNtupleReader_cxx
ETHZNtupleReader::ETHZNtupleReader(TTree *tree)
{
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      ...
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("dcap://t3se01.psi.ch:22125/pnfs/psi.ch/cms/trivcat/store/user/susy/ntuples/mc/V01-11-03/GluGluToHToWWTo2L2Nu_M-130_7TeV-powheg-pythia6/NTupleProducer_38X_MC_RECO_236_1_5st.root");
      if (!f) {
         f = new TFile("dcap://t3se01.psi.ch:22125/pnfs/psi.ch/cms/trivcat/store/user/susy/ntuples/mc/V01-11-03/GluGluToHToWWTo2L2Nu_M-130_7TeV-powheg-pythia6/NTupleProducer_38X_MC_RECO_236_1_5st.root");
         f->cd("PyROOT:/");
      }
      tree = (TTree*)gDirectory->Get("analyze/Analysis");
      ...
      chain->Add("dcap://t3se01.psi.ch:22125/pnfs/psi.ch/cms/trivcat/store/user/susy/ntuples/mc/V01-11-03/GluGluToHToWWTo2L2Nu_M-130_7TeV-powheg-pythia6/NTupleProducer_38X_MC_RECO_236_1_5st.root/analyze/Analysis");
      tree = chain;
#endif // SINGLE_TREE
...
ETHZNtupleReader::~ETHZNtupleReader()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t ETHZNtupleReader::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t ETHZNtupleReader::LoadTree(Long64_t entry)
{
...
void ETHZNtupleReader::Init(TTree *tree)
{
...
Bool_t ETHZNtupleReader::Notify()
{
...
void ETHZNtupleReader::Show(Long64_t entry)
{
...
Int_t ETHZNtupleReader::Cut(Long64_t entry)
{
...
#endif // #ifdef ETHZNtupleReader_cxx
